  ...
  return (
    <>
      {todo?.map((t: any) => {
        ...
        const monthAbbreviation = updatedAtDate
        ...
        return (
          <div
            key={t._id}
            className={`card w-72 bg-base-100 shadow-xl card-bordered rounded-3xl border-4 ${
              t.prio === "high" ? "border-red-400" : "border-orange-200"
            }`}
          >
            <div className="card-body overflow-auto">
              ...
              <div className="badge badge-secondary justify-start font-bold">
                {dayAbbreviation}
              </div>
              <hr className="h-px my-1 bg-gray-200 border-0 dark:bg-gray-700"></hr>
              <p>
                <pre className="whitespace-pre-line text-pretty break-word overflow-hidden text-overflow-ellipsis">
                  {t.desc}
                </pre>
              </p>
